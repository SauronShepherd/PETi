...
def main() -> int:
    evidence_files = [
        ...
        "firestore.rules",
        "storage.rules",
        "docs/PHASES_0_17_PENDING_CHECKLIST.md",
        "docs/PHASES_0_17_CONTINUATION_STATUS.md",
        "eval/weekly_report/run.py",
        "infra/monitoring/monitoring.yaml",
        "docs/operations/SLOS.md",
        "backend/app/billing/google_play.py",
        "backend/app/billing/premium.py",
        "backend/app/billing/rtdn.py",
        ...
        "docs/HACKATHON_TESTING_INSTRUCTIONS.md",
        "docs/CODE_DISCLOSURE.md",
        ...
        "release/HUMAN_VALIDATION_HANDOFF.md",
        "scripts/pre-human-validation.ps1",
        "release/SOURCE_DOCUMENT_RECONCILIATION.md",
        "docs/adr/ADR_INDEX.md",
        "docs/adr/ADR-191-media-format-and-audio-capture.md",
        "docs/runbooks/UPLOAD_KEY_RECOVERY.md",
        "docs/runbooks/EXTERNAL_PHASES_0_17_EXECUTION_CHECKLIST.md",
        "docs/runbooks/EXTERNAL_QUALIFICATION_EXECUTION_CHECKLIST.md",
        "release/PLAY_APP_SIGNING_CONFIGURATION.md",
        "release/evaluation/WEEKLY_REPORT_RELEASE_DECISION_1.0.0.md",
        "release/evaluation/WEEKLY_REPORT_RELEASE_DECISION_1.0.0.json",
        "release/evaluation/PREMIUM_RELEASE_DECISION_1.0.0.md",
    ...
    payload = {
        ...
        "external_gates": {
            ...
            "google_play": "PENDING_EXTERNAL_ACCOUNT",
            "physical_devices": "PENDING_EXTERNAL_EXECUTION",
            "production_signing": "PENDING_EXTERNAL_KEY_MATERIAL",
        },
        "artifacts": artifacts,
    }
    ...
    phase17.write_text(
        json.dumps({
            ...
            "external_gates": ["play_console", "production_gcp", "signed_aab", "public_https_resources", "store_review"],
        }, indent=2) + "\n",
        encoding="utf-8",
    )
    trace_rows = [
