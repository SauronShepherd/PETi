...
object PetiNotificationService {
    fun show(context: android.content.Context, message: RemoteMessage) {
        ...
        val notification = NotificationCompat.Builder(context, channelId).setSmallIcon(android.R.drawable.ic_dialog_info).setContentTitle("Recordatorio de cuidado").setContentText("Tu mascota tiene un cuidado pendiente").setContentIntent(pending).setAutoCancel(true).build()
