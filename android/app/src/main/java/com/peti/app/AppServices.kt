...
interface AppServices { val auth: AuthRepository; val species: SpeciesRepository; val pets: PetRepository; val analysis: AnalysisRepository; val funding: FundingRepository; val mediaUpload: MediaUploadCoordinator; val phase6: Phase6Repository; val records: RecordsRepository; val specialists: SpecialistRepository; val reports: ReportsRepository; val future: FutureRepository }
