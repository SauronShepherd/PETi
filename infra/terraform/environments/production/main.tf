...
variable "ai_provider" { type = string, default = "FAKE" }
variable "ai_enabled" { type = bool, default = false }
variable "ai_provider_enabled" { type = bool, default = false }
variable "ai_model_enabled" { type = bool, default = false }
